...
//   String get appName => widget.appName ?? 'Quick Notes';
...
class _PrivacyPolicyPageState extends State<PrivacyPolicyPage> with SingleTickerProviderStateMixin {
  ...
  // OPTION TO SHOW/HIDE APPBAR - Change this to your preference
  final bool _useAppBar = false; // Set to false to hide AppBar and use floating button
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // OPTION 1: Use transparent/minimal AppBar
      appBar: _useAppBar ? CommonAppBar(
        type: AppBarType.other,
        title: 'Privacy Policy',
      ...
      // OPTION 2: No AppBar, use WillPopScope for browser back button
      body: WillPopScope(
        onWillPop: () async {
        ...
        child: Stack(
          children: [
            ...
            // OPTION 3: Floating back button when AppBar is hidden
            if (!_useAppBar)
              FloatingBackButton(
    ...
    return Container(
      ...
      child: Column(
        children: [
          Icon(
            FontAwesomeIcons.shieldAlt,
            size: ResponsiveHelper.isMobile(context) ? 50 : 70,
            color: Colors.white,
          ),
          SizedBox(height: 20),
          Text(
