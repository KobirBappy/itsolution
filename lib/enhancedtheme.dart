...
import 'ai-floating-chat-widget.dart';
...
// Stat model class for achievements section
class Stat {
  final IconData icon;
  final String value;
  final String label;
...
class _EnhancedLandingPageState extends State<EnhancedLandingPage>
  ...
  EdgeInsets getResponsivePadding(BuildContext context) {
    if (isMobile(context))
      return EdgeInsets.symmetric(horizontal: 20, vertical: 40);
    if (isTablet(context))
      return EdgeInsets.symmetric(horizontal: 40, vertical: 60);
      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            _buildDrawerItem(Icons.shopping_bag, 'Shop', '/products', context,
                isHighlighted: true),
            _buildDrawerItem(
                Icons.design_services, 'Services', '/services', context),
            _buildDrawerItem(Icons.info, 'About', null, context),
            _buildDrawerItem(
                Icons.contact_mail, 'Contact', '/contact', context),
            Divider(),
            _buildDrawerItem(Icons.login, 'Login', '/unified-login', context,
                isSpecial: true),
          ],
        ),
      ),
  ...
  Widget _buildDrawerItem(
      ...
      {bool isHighlighted = false, bool isSpecial = false}) {
    return Container(
      ...
      child: ListTile(
        leading: Icon(
          ...
          color: isHighlighted
              ? Colors.orange
              : (isSpecial ? Colors.blue : Colors.grey.shade700),
        ),
        title: Text(
          title,
          style: TextStyle(
  ...
  Widget _buildEnhancedHeroSection() {
    ...
    final heroHeight =
        isMobile(context) ? screenHeight * 0.9 : screenHeight * 0.8;
  ...
  Widget _buildHeroButton(String text, IconData icon, Color color,
      VoidCallback onPressed, bool filled) {
            ...
            itemBuilder: (context, index) {
              ...
              final stat = Stat(
                icon: FontAwesomeIcons
                    .award, // Replace with appropriate icon if available in statMap
                      ...
                      AnimatedBuilder(
                        ...
                        builder: (context, child) {
                          return Transform.scale(
                            ...
                            child: Container(
                              padding:
                                  EdgeInsets.all(isMobile(context) ? 15 : 20),
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  colors: [
    ...
    final testimonials = [
      {
        ...
        'text':
            'Excellent service! They transformed our entire IT infrastructure.',
        'rating': 5,
      },
      {
        'name': 'Jane Smith',
        ...
        'text':
            'Professional team with innovative solutions. Highly recommended!',
        'rating': 5,
      },
      {
        'name': 'Mike Johnson',
                  ...
                  children: [
                    Container(
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundImage:
                            NetworkImage(testimonial['image'] as String),
                      ),
                    ),
                    SizedBox(height: 20),
                    Row(
  ...
  Widget _buildFooter() {
    return Container(
      padding: EdgeInsets.symmetric(
          vertical: isMobile(context) ? 40 : 60, horizontal: 20),
      decoration: BoxDecoration(
        gradient: LinearGradient(
          begin: Alignment.topCenter,
          end: Alignment.bottomCenter,
                ...
                child: Transform.rotate(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius:
                          index % 2 == 0 ? null : BorderRadius.circular(20),
                    ),
                  ),
                ),
              );
